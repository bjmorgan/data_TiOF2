...
# save configurational degeneracies.
with open('TiOF2 2x2x2 degeneracies.dat', 'w') as f:
    f.write('# config degeneracy\n')
    for i, s in enumerate(unique_structures):
        f.write(f'{i} {s.number_of_equivalent_configurations}\n') 
